...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><span class="btn">Create Product Variant</span><a class="btn btn-primary float-end" href="{{route('products.index')}}">All Products</a></div>

                <div class="card-body">
                    <form method="POST" action="{{ route('products.variant.store') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" complete="price">
