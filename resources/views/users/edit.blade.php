                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="date_of_birth" value="{{Auth::user()->date_of_birth}}" 
                                type="date" class="form-control @error('date_of_birth') 
                                is-invalid @enderror" name="date_of_birth" 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" value="{{Auth::user()->country}}"
                            ...
                            <div class="col-md-6">
                                <select class="form-control col-md-3" id="city" name="city">
                                    ...
                                    @foreach ($cities as $city)
                                        <option value="{{$city->location_name}}" @if ($user->city == $city->location_name)
                                            selected
                                        @endif>
                                            {{$city->location_name}}
                                        </option>
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="form-check">
                                    <input type="radio" value="1"
                                     name="status" class="form-check-input" id="status1" 
                                    value="{{ old('status') }}" autocomplete="status" @if ($user->status == true)
                                        checked
                                    @endif>
                                ...
                                <div class="form-check">
                                    <input type="radio" name="status" value="0"
                                     class="form-check-input" id="status0" value="{{ old('status') }}"
                                      autocomplete="status" @if ($user->status == false)
                                      checked
                                  @endif>
